exports.seed = function(knex, Promise) {
  ...
  //data in orders
  knex('orders').insert({id: 1, name: 'Alice', phone_number: '7770987654', status: "picked up", estimated_time: 5}),
  knex('orders').insert({id: 2, name: 'Bob', phone_number: '9990010000', status: "outstanding", estimated_time: 7}),
  knex('orders').insert({id: 3, name: 'Charlie', phone_number: '4443332222', status: "outstanding", estimated_time: 15})
  ])).then(() => Promise.all([
  //data in ingredients
